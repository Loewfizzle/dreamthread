...
import { extractKeywords, parseDreamDate, getExcerpt, formatDreamDate } from '@/lib/dream-utils';
import { shareYearCard, type YearCardStats } from '@/lib/postcard';
...
interface YearStats extends YearCardStats {
...
// All time math runs here, called from the load effect (not render)
function computeYearStats(dreams: Dream[], year: number): YearStats {
  const inYear = dreams
